...
begin
 ...
 begin
  repeat
   write('¬ведите размерность (не более ',n,') квадратного массива N: ');     // проверка длинны строки
   readln(n2);
   ...
   begin
    ...
    begin
     writeln('Error, please try again');
        repeat
         write('¬ведите размерность (не более ',n,') квадратного массива N: ');          // проверка длинны строки  снова
         readln(n2);
         if length(n2)>4 then writeln('Error, please try again');
        until length(n2)<=4 ;
    end;
  ...
  begin
   ...
   begin
    repeat
    write('¬ведите [',i,', ',j,'] элемент массива: ');
    readln(n2);
    val(n2,rab1,cod);
  ...
  for i := 1 to n1 do
   ...
   {—оставл€ем B массив бега€ по спирали A массива}
   if n1 mod 2=0 then
   begin
     x:=n1 div 2;
     y:=n1 div 2;
